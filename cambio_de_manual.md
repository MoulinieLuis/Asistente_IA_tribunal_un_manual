...
- Si deseas conservar embeddings de manuales anteriores:
  - Renombra los archivos `.faiss` y `.pkl` antes de generar los nuevos.  
    Ejemplo:  
    `manual_antiguo.index`  
    `manual_antiguo.pkl`
- Esto te permitirá alternar entre manuales sin recalcular embeddings cada vez.
